...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
        ...
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ml-auto">
                ...
                <li class="nav-item dropdown dropdown-cart mr-25"><a class="nav-link" href="javascript:void(0);" data-toggle="dropdown"><i class="ficon" data-feather="shopping-cart"></i><span class="badge badge-pill badge-primary badge-up cart-item-count">6</span></a>
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                        ...
                        <li class="scrollable-container media-list">
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?php echo HTTP_HOST . 'app/assets/' ?>images/pages/eCommerce/1.png" alt="donuts" width="62">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?php echo HTTP_HOST . 'app/assets/' ?>images/pages/eCommerce/7.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?php echo HTTP_HOST . 'app/assets/' ?>images/pages/eCommerce/2.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?php echo HTTP_HOST . 'app/assets/' ?>images/pages/eCommerce/3.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                            ...
                            <div class="media align-items-center"><img class="d-block rounded mr-1" src="<?php echo HTTP_HOST . 'app/assets/' ?>images/pages/eCommerce/5.png" alt="donuts" width="62">
                                <div class="media-body"><i class="ficon cart-item-remove" data-feather="x"></i>
                                    <div class="media-heading">
                        ...
                        <li class="scrollable-container media-list"><a class="d-flex" href="javascript:void(0)">
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/portrait/small/avatar-s-15.jpg" alt="avatar" width="32" height="32"></div>
                                    </div>
                                ...
                                <div class="media d-flex align-items-start">
                                    <div class="media-left">
                                        <div class="avatar"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/portrait/small/avatar-s-3.jpg" alt="avatar" width="32" height="32"></div>
                                    </div>
                                    <div class="media-body">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name font-weight-bolder">John Doe</span><span class="user-status">Admin</span></div><span class="avatar"><img class="round" src="<?php echo HTTP_HOST . 'app/assets/' ?>images/portrait/small/avatar-s-11.jpg" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
    ...
    <ul class="main-search-list-defaultlist d-none">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div class="d-flex">
                    <div class="mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/icons/xls.png" alt="png" height="32"></div>
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div class="d-flex">
                    <div class="mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/icons/jpg.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div class="d-flex">
                    <div class="mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/icons/pdf.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between w-100" href="app-file-manager.html">
                <div class="d-flex">
                    <div class="mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/icons/doc.png" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view.html">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/portrait/small/avatar-s-8.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view.html">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/portrait/small/avatar-s-1.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view.html">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/portrait/small/avatar-s-14.jpg" alt="png" height="32"></div>
                    <div class="search-data">
        ...
        <li class="auto-suggestion"><a class="d-flex align-items-center justify-content-between py-50 w-100" href="app-user-view.html">
                <div class="d-flex align-items-center">
                    <div class="avatar mr-75"><img src="<?php echo HTTP_HOST . 'app/assets/' ?>images/portrait/small/avatar-s-6.jpg" alt="png" height="32"></div>
                    <div class="search-data">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="../../../html/ltr/vertical-menu-template-bordered/index.html">
                        ...
                        <h2 class="brand-text">
                            <img src="<?php echo LOGO_C ?>" alt="" width="35" srcset="">
                            Softmor POS
                        </h2>
                    </a></li>
    ...
    <div class="app-content content ">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                ...
                $listaBlanca = AppControlador::obtenerListaBlancaAdmin();

                // preArray($listaBlanca);
                ...
                if (isset($_GET['ruta'])) {
                    ...
                    foreach ($listaBlanca as $key => $lsb) {
                        if ($lsb == $ruta_act) {
                            $_404 = false;
                        }
                    }

                    $pagina = $_404 ? '404' : $ruta_act;
                    cargarPagina($pagina, $rutas);
    ...
    <script src="<?php echo HTTP_HOST . 'app/assets/' ?>vendors/js/extensions/toastr.min.js"></script>
    <!-- END: Page Vendor JS-->
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?php echo HTTP_HOST . 'app/assets/' ?>js/scripts/pages/dashboard-ecommerce.js"></script>
    <!-- END: Page JS-->
